...
if (isset($_SESSION['email'])) {
    ...
    $rol = $_SESSION['rol'];
    $fono = $_SESSION['numero_telefonico'];
    $fecha_nacimiento = $_SESSION['fecha_nacimiento'];
    $edad = $_SESSION['edad'];
    $direccion = $_SESSION['direccion'];
    $rutaImagenCompleta = 'html/assets/images/fotos/default.jpg'; // Asigna la ruta de la imagen por defecto
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-widget" role="button" aria-expanded="false" aria-controls="sidebar-widget">
                            ...
                            <span class="item-name">Bodegas en Inventario</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#bodega30rpCollapse">
                                    ...
                                    <span class="item-name">BODEGA-30RP</span>
                                </a>
                                <div class="collapse" id="bodega30rpCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="../dashboard/table/table-data12.php">Cotejo de Inventario</a></li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-17RPrpCollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA-17RP</span>
                                </a>
                                <div class="collapse" id="BODEGA-17RPrpCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data2.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-29-RT-REPARACIONESCollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA 29 RT REPARACIONES</span>
                                </a>
                                <div class="collapse" id="BODEGA-29-RT-REPARACIONESCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data3.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-35-AUTOMATCollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA-35-AUTOMAT</span>
                                </a>
                                <div class="collapse" id="BODEGA-35-AUTOMATCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data4.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-3RPCollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA-3RP</span>
                                </a>
                                <div class="collapse" id="BODEGA-3RPCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data5.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-8-MANTCollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA-8 MANT</span>
                                </a>
                                <div class="collapse" id="BODEGA-8-MANTCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data6.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-9-HIDRAULICACollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA-9 HIDRAULICA</span>
                                </a>
                                <div class="collapse" id="BODEGA-9-HIDRAULICACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data7.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-10-SERV-HIDCollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA-10-SERV HID</span>
                                </a>
                                <div class="collapse" id="BODEGA-10-SERV-HIDCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data8.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-17-DEV-CLTCollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA-17 DEV CLT</span>
                                </a>
                                <div class="collapse" id="BODEGA-17-DEV-CLTCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data9.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" data-target="#BODEGA-CALAMACollapse">
                                    ...
                                    <i class="sidenav-mini-icon"> W </i>
                                    <span class="item-name">BODEGA-CALAMA</span>
                                </a>
                                <div class="collapse" id="BODEGA-CALAMACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data10.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li>
                                        <li><a href="#">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="MATERIA-PRIMACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data11.php">Ver Inventario</a></li>
                                        <li><a href="/html/dashboard/form/">Ingresar Producto</a></li>
                                        <li><a href="../dashboard/table/table-data13.php">Cotejo de Inventario</a></li>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
      ...
      <div class="row">
                  ...
                  <div class="card-body">
                     <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="d-flex flex-wrap align-items-center">
                           ...
                           // Verificar si el usuario está autenticado
                           if (isset($_SESSION['id'])) {
                              echo '<img src="' . $imagen_perfil . '" style="height: 160px; width: 140px; min-width: 50px;" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">';
                           } else {
                              echo '<img src="' . $imagen_perfil . '" style="height: 160px; width:140px; min-width: 50px;" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">';
                           }
                           ?>
                           ...
                           <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                              <h4 class="me-2 h4"><?php echo $nombre_de_usuario ." ". $last_name; ?></h4>
          ...
          <div id="profile-profile" >
            <div class="card iq-navbar-header" >
                ...
                <div class="card-body" >
                    <div class="text-center">
                        <div class="user-profile">
                            ...
                            // Verificar si el usuario está autenticado
                            if (isset($_SESSION['id'])) {
                                echo '<img src="' . $imagen_perfil . '" style="height: 220px; width: 200px; min-width: 180px;" alt="User-Profile" class="img-fluid avatar avatar-50 avatar-rounded">';
                            }
                        ...
                        <div>
                            <h3 style="color: black;" ><?php echo $nombre_de_usuario ." ". $last_name; ?></h3><br>
                            <strong><p style="color: black;" > - <?php echo $rol; ?></p><br></strong>
                            <p style="color: black;">En este espacio encontrarás tus datos personales y necesarios para tu contacto o ingreso de sesión, los cuales podrás modificar o actualizarlos.</p>
                        </div>
            ...
            <div class="card">
               <div class="card-header">
                     <h4 class="card-title">Sobre tí</h4>
               </div>
               <div class="card-body">
                    <div class="user-bio text-center mb-5 ">
                        <p>En esta sección encontrarás todos tus datos personales registrados en nuestra plataforma...</p>
                       
                    </div>
                    <div class="container" style="background-image: url(/preview.jpg)!important;">
                        <div class="row">
                            <!-- Primera columna -->
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title" style="color:blue"><i class="fa fa-user me-2" aria-hidden="true"></i>Nombre completo:</h5>
                                        <p class="card-text"><?php echo $nombre_de_usuario;?></p>
                                    </div>
                                </div>
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title" style="color:blue"><i class="fa fa-calendar me-2" aria-hidden="true"></i>Tu edad:</h5>
                                        <p class="card-text"><?php echo $edad;?></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Segunda columna -->
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title" style="color:blue"><i class="fa fa-birthday-cake me-2" aria-hidden="true"></i>Fecha de Nacimiento:</h5>
                                        <p class="card-text"><?php echo $fecha_nacimiento;?></p>
                                    </div>
                                </div>
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title" style="color:blue"><i class="fa fa-home me-2" aria-hidden="true"></i>vives:</h5>
                                        <p class="card-text"><?php echo $direccion;?></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Tercera columna -->
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title" style="color:blue"><i class="fa fa-envelope me-2" aria-hidden="true"></i>Email:</h5>
                                        <p class="card-text"><?php echo $email;?></p>
                                    </div>
                                </div>
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title" style="color:blue"><i class="fa fa-link me-2" aria-hidden="true"></i>Url:</h5>
                                        <p class="card-text"><a href="http://www.hvjservices.cl" class="text-body" target="_blank">http://www.hvjservices.cl</a></p>
                                    </div>
                                </div>
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <h5 class="card-title" style="color:blue"><i class="fa fa-phone me-2" aria-hidden="true"></i>Contacto:</h5>
                                        <p class="card-text"><?php echo $fono;?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
