            ...
            <div class="col-sm-12">
               <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/BODEGA-35-AUTOMAT.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" pattern="\d*([\.,]\d{2})?" class="form-control" id="valor_unidad" name="valor_unidad" required title="Por favor, ingrese un número con hasta dos decimales, usando punto o coma como separador decimal. Ejemplo: 1234,56">
