                      ...
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/BODEGA-CALAMA.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="tabla_seleccionada">Seleccionar Tabla</label>
                                    <select class="form-control" id="detalle" name="detalle">
                                        <option value="">Seleccione la bodega a ingresar</option>
                                        <?php
                                        ...
                                        try {
                                            ...
                                            $tablasExcluidas = [
                                                ...
                                                'bordes_y_rodones',  
                                                'fundas', 
                                                'RACKS P/CATODOS DE EXPORTACION', 
                                                'resumen_bodegas', 
                                                'usuarios'
                                            ];

                                            // Añadir las tablas como opciones en el select, excluyendo las deseadas
                                            foreach ($tablas as $fila) {
                                                if (!in_array($fila[0], $tablasExcluidas)) {
                                                    echo "<option value='" . htmlspecialchars($fila[0]) . "'>" . htmlspecialchars($fila[0]) . "</option>";
                                                }
                                            }
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="valor_universo_total">Valor Universo Total*</label>
                                    <input type="number" step="0.01" class="form-control" id="valor_universo_total" name="valor_universo_total" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="toma_inventario">Toma Inventario*</label>
                                    <input type="number" class="form-control" id="toma_inventario" name="toma_inventario" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="valor_contable">Valor Contable*</label>
                                    <input type="number" step="0.01" class="form-control" id="valor_contable" name="valor_contable" required>
                                </div>
