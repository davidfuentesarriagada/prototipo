...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        echo '<script>alert("Auditor guardado correctamente."); window.location.href = "http://localhost/prototipo/html/dashboard/table/BODEGA-17RP.php";</script>';
    } else {
        echo '<script>alert("Error al guardar el auditor: ' . $conn->error . '"); window.location.href = "http://localhost/prototipo/html/dashboard/table/BODEGA-17RP.php";</script>';
    }
