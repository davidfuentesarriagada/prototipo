...
//$existencia_en_inventario = isset($_POST['existencia_en_inventario']) ? floatval($_POST['existencia_en_inventario']) : 0;
//$valor_unidad = isset($_POST['valor_unidad']) ? floatval($_POST['valor_unidad']) : 0;
...
$tablas_permitidas = ['MATERIAL_FERRETERIA', 'MATERIAL_TRANSMISION', 'MATERIAL_ELECTRICO', 'MAQUINAS_Y_HERRAMIENTAS', 'REPUESTOS', 'mantencion'];
...
if ($stmt->execute()) {
    ...
    echo "<script>setTimeout(function() { window.location.href = 'http://localhost/prototipo/html/dashboard/table/BODEGA-35-AUTOMAT.php'; }, 2000);</script>";
} else {
