...
$tablas_permitidas = ['activo_fijo2', 'material_ferreteria4', 'material_electrico3', 'material_vehiculos2', 'material_hiudraulico3', 'material_seguridad_articulos_seguridad','discos','cintas','soldaduras','repuestos4','quimicos','bordes'];
...
if ($stmt->execute()) {
    ...
    echo "<script>setTimeout(function() { window.location.href = 'http://localhost/prototipo/html/dashboard/table/BODEGA-CALAMA.php'; }, 2000);</script>";
} else {
