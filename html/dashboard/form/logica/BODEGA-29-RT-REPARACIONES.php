...
$sql = "INSERT INTO `bodega-29-rt-reparaciones` (codigo_producto, nombre_y_detalles, existencia_en_inventario, valor_unidad, valor_total, valor_inv_auditoria, observaciones_ubicacion, `invent_cobra`, `AUDITORIA_HVJ`, DIFERENCIA)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
if ($stmt->execute()) {
    ...
    echo "<script>setTimeout(function() { window.location.href = 'http://localhost/prototipo/html/dashboard/table/BODEGA-29-RT-REPARACIONES.php'; }, 2000);</script>";
} else {
