...
$sql = "INSERT INTO `bodega-35-automat` (codigo_producto, nombre_y_detalles, existencia_en_inventario, valor_unidad, valor_total, valor_inv_auditoria, observaciones_ubicacion, `invent_cobra`, `AUDITORIA_HVJ`, DIFERENCIA)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
