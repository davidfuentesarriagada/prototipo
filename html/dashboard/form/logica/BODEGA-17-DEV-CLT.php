...
$sql = "INSERT INTO `bodega_17_dev_clt` (codigo_producto, nombre_y_detalles, existencia_en_inventario, valor_unidad, valor_total, valor_INV_auditoria, observaciones_ubicacion, `invent_cobra`, `AUDITORIA_HVJ`, diferencia)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
if ($stmt->execute()) {
    ...
    echo "<script>setTimeout(function() { window.location.href = 'http://localhost/prototipo/html/dashboard/table/BODEGA-17-DEV-CLT.php'; }, 2000);</script>";
} else {
