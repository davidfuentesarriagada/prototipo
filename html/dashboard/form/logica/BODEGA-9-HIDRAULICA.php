...
$tablas_permitidas = ['sin_denominacion', 'material_ferreteria3', 'material_maestranza', 'material_hiudraulico2', 'herramientas', 'soldadoras','repuestos3','venta_de_repuestos','servicios_hidraulicos2','reparaciones_hidraulicas'];
...
if ($stmt->execute()) {
    ...
    echo "<script>setTimeout(function() { window.location.href = 'http://localhost/prototipo/html/dashboard/table/BODEGA-9-HIDRAULICA.php'; }, 2000);</script>";
} else {
