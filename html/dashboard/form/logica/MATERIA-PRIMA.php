...
$tablas_permitidas = ['acero_470li', 'acero_316l', 'aceros_historicos', 'barras', 'bordes_y_rodones', 'fundas', 'racks'];
...
if ($stmt->execute()) {
    ...
    echo "<script>setTimeout(function() { window.location.href = 'http://localhost/prototipo/html/dashboard/table/MATERIA-PRIMA.php'; }, 2000);</script>";
} else {
