            ...
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="../dashboard/index.php" tabindex="-1">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="bodega30rpCollapse"><br>
                                    ...
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-30RP.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/ingreso.php">Ingresar Producto</a></li>
                                        <li><a href="../dashboard/form/ingreso_muestra.php">Ingreso de muestra</a></li><br>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-17RPrpCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-17RP.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/ingreso2.php">Ingresar Producto</a></li>
                                        <li><a href="../dashboard/form/ingreso_muestra2.php">Ingreso de muestra</a></li><br>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-29-RT-REPARACIONESCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-29-RT-REPARACIONES.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/ingreso3.php">Ingresar Producto</a></li>
                                        <li><a href="../dashboard/form/ingreso_muestra3.php">Ingreso de muestra</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-35-AUTOMATCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-35-AUTOMAT.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/formulario-bod35aut.php">Ingresar Producto</a></li>
                                        <li><a href="../dashboard/form/ingreso_muestra4.php">Ingreso de muestra</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-3RPCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-3RP.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/ingreso5.php">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-8-MANTCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-8-MANT.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/ingreso6.php">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-9-HIDRAULICACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-9-HIDRAULICA.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/ingreso7.php">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-10-SERV-HIDCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-10-SERV-HID.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/ingreso8.php">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-17-DEV-CLTCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-17-DEV-CLT.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/ingreso9.php">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-CALAMACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/BODEGA-CALAMA.php">Ver Inventario</a></li>
                                        <li><a href="/dashboard/form/ingreso10.php">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="MATERIA-PRIMACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/MATERIA-PRIMA.php">Ver Inventario</a></li>
                                        <li><a href="../dashboard/form/formulario-materia.php">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                        ...
                        <ul class="sub-nav collapse" id="resumenBodegas" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="#verTotales" data-toggle="collapse" data-target="#verTotalesCollapse">
                                    ...
                                    <li><a href="../dashboard/table/resumenes.php"><i class="fa-solid fa-check-double"></i>  Ver totales</a></li>
                                    <li><a href="../dashboard/form/ingreso-resumen.php"><i class="fa-solid fa-check-double"></i>  Ingresar Producto</a></li><br>
                                </a>
                      ...
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                  ...
                                  <p>En este segmento podras ingresar algun Producto al inventario de la bodega BODEGA-8 MANT para su resgistro</p>
                              </div>
            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title"> Formulario de Ingresos para BODEGA-8 MANT </h4>
                     </div>
                  </div>
                  <div class="card-body">
                      <p>Por favor, complete el siguiente formulario para registrar nuevos productos en el inventario de nuestra empresa.</p>
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/BODEGA-8-MANT.php" method="post">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="codigo_producto">Código del Producto*</label>
                                <input type="text" class="form-control" id="codigo_producto" name="codigo_producto" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="nombre_y_detalles">Nombre y Detalles*</label>
                                <input type="text" class="form-control" id="nombre_y_detalles" name="nombre_y_detalles" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="existencia_en_inventario">Existencia en Inventario*</label>
                                <input type="number" class="form-control" id="existencia_en_inventario" name="existencia_en_inventario" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="valor_unidad">Valor Unidad*</label>
                                <input type="number" step="0.01" class="form-control" id="valor_unidad" name="valor_unidad" required>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label" for="observaciones_ubicacion">Observaciones UBICACIÓN</label>
                                <textarea class="form-control" id="observaciones_ubicacion" name="observaciones_ubicacion" rows="3"></textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="invent_cobra">INVENT_COBRA</label>
                                <input type="text" class="form-control" id="invent_cobra" name="invent_cobra">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="auditoria_hvj">AUDITORIA HVJ</label>
                                <input type="text" class="form-control" id="auditoria_hvj" name="auditoria_hvj">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="base_de_datos">Seleccione la Sub Bodega a Ingresar</label>
                                <select class="form-control" id="nombre_tabla" name="nombre_tabla">
                                    <option value="">Seleccione su Sub bodega</option>
                                    <option value="sin_definicion">sin definicion</option>
                                    <option value="material_ferreteria2">material ferreteria</option>
                                    <option value="material_electrico">material electrico</option>
                                    <option value="material_vehiculos">material vehiculos</option>
                                    <option value="material_hidraulico">material hidraulico</option>
                                    <option value="servicios_hidraulicos">servicios hidraulicos</option>
                                    <option value="maquinas_y_herramientas">maquinas y herramientas</option>
                                    <option value="maquinarias_varias">MAQUINARIAS VARIAS</option>
                                    <option value="repuestos2">repuestos</option>
                                    <option value="repuestos_correa_transportadora">repuestos correa transportadora</option>
                                    <option value="mantencion2">mantención</option>
                                    <option value="soldaduras_y_soldadoras">soldaduras y soldadoras</option>
                                    <option value="pulimero">pulimero</option>
                                    <option value="alizadora">alizadora</option>
                                    <option value="lavadora">lavadora</option>
                                    <option value="v_grouve">v_grouve</option>
