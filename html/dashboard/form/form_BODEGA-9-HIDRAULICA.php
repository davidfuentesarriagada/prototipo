            ...
            <div class="col-sm-12">
               <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/BODEGA-9-HIDRAULICA.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="nombre_tabla" name="nombre_tabla">
                                    ...
                                    <option value="sin_denominacion">sin denominacion</option>
                                    <option value="material_ferreteria3">material ferreteria</option>
                                    <option value="material_maestranza">material maestranza</option>
                                    <option value="material_hiudraulico2">material hiudraulico</option>
                                    <option value="herramientas">herramientas</option>
                                    <option value="soldadoras">soldadoras</option>
                                    <option value="repuestos3">repuestos</option>
                                    <option value="venta_de_repuestos">venta de repuestos</option>
                                    <option value="servicios_hidraulicos2">servicios hidraulicos</option>
                                    <option value="reparaciones_hidraulicas">reparaciones hidraulicas</option>
