                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="bodega30rpCollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso.html">Ingresar Producto</a></li><br>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-17RPrpCollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso2.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-29-RT-REPARACIONESCollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso3.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-35-AUTOMATCollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso4.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-3RPCollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso5.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-8-MANTCollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso6.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-9-HIDRAULICACollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso7.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-10-SERV-HIDCollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso8.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-17-DEV-CLTCollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso9.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-CALAMACollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso10.html">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="MATERIA-PRIMACollapse"><br>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/html/dashboard/form/ingreso11">Ingresar Producto</a></li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
            ...
            <div class="col-sm-12">
               <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/ingreso-30RP.php" method="post">
                        <div class="row">
