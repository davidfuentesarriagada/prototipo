                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                  <h1>Ingreso de Auditor Registrado</h1>
                                  <p>En este segmento podras Registar a auditor a cargo de contabilizar esta bodega.</p>
                              </div>
            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title"> Formulario de Ingresos del Auditor a cargo. </h4>
                     </div>
                  </div>
                  <div class="card-body">
                        <p>Por favor, complete el siguiente formulario para registrar el auditor a cargo de esta auditoria.</p>
                        <form action="http://localhost/prototipo/html/dashboard/form/logica/guardar_auditor11.php" method="post">
                            <div class="mb-4">
                                <label for="hechoPor" class="form-label">Hecho por:</label>
                                <select class="form-select" id="hechoPor" name="hecho_por" required>
                                    ...
                                    // Consulta SQL para obtener los nombres de los auditores desde la tabla listado_auditores
                                    $query = "SELECT nombre_apellido FROM lista_auditores";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo '<option value="' . $nombreApellido . '">' . $nombreApellido . '</option>';
                                        }
                                    } else {
                                        echo '<option value="">No hay auditores disponibles</option>';
                                    }
                            ...
                            <div class="mb-4">
                                <label for="revisadoPor" class="form-label">Revisado por:</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="fechaRevision" name="fecha_revision">
                            </div>
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="bodega" name="bodega" required>
                                    ...
                                    // Consulta SQL para obtener los nombres de los auditores desde la tabla listado_auditores
                                    $query = "SELECT nombre FROM bodega";
                                    $result = $conn->query($query);
