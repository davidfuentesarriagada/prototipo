                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="http://localhost/prototipo/html/dashboard/table/table-data.php" data-toggle="collapse" data-target="#bodega30rpCollapse">
                                    <i class="icon">
                                ...
                                <div class="collapse" id="bodega30rpCollapse">
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="../dashboard/table/table-data.php">Ver Inventario</a></li>
                                        <li><a href="/dashboard/form/ingreso.htlm">Ingresar Producto</a></li>
            ...
            <div class="col-sm-12">
               <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/BODEGA-CALAMA.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="nombre_tabla" name="nombre_tabla">
                                    ...
                                    <option value="activo_fijo2">activo fijo</option>
                                    <option value="material_ferreteria4">material ferreteria</option>
                                    <option value="material_electrico3">material electrico</option>
                                    <option value="material_vehiculos2">material vehiculos</option>
                                    <option value="material_hiudraulico3">material hidraulico</option>
                                    <option value="material_seguridad_articulos_seguridad">material de seguridad y articulos de seguridad</option>
                                    <option value="discos">discos</option>
                                    <option value="cintas">cintas</option>
                                    <option value="soldaduras">soldaduras</option>
                                    <option value="repuestos4">repuestos</option>
