            ...
            <div class="col-sm-12">
               <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/log_3rp.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="base_de_datos">Seleccione una Base de Datos</label>
                                <select class="form-control" id="nombre_tabla" name="nombre_tabla">
                                    <option value="">Seleccione su bodega</option>
                                    <option value="bodega3mt">bodega3mt</option>
                                    <option value="activo_fijo">activo_fijo</option>
                                    <option value="repuestos_servicios">repuestos_servicios</option>
                                    <option value="bienes_servicios_generales">bienes_servicios_generales</option>
                                    <option value="bienes_servicios_mantenimiento">bienes_servicios_mantenimiento</option>
                                    <option value="reparaciones">reparaciones</option>
                                    <option value="servicios_mecanicos">servicios_mecanicos</option>
