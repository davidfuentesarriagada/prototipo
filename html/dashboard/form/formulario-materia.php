            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title"> Formulario de Ingresos para BODEGA Materia Prima</h4>
                     </div>
                  </div>
                  <div class="card-body">
                      <p>Por favor, complete el siguiente formulario para registrar nuevos productos en el inventario de nuestra empresa.</p>
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/MATERIA-PRIMA.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="nombre_tabla" name="nombre_tabla">
                                    ...
                                    <option value="acero_470li">acero 470li</option>
                                    <option value="acero_316l">acero 316l</option>
                                    <option value="aceros_historicos">aceros historicos</option>
                                    <option value="barras">barras</option>
                                    <option value="bordes_y_rodones">bordes y rodones</option>
