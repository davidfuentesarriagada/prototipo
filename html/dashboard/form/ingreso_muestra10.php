...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Master One, Ingreso de productos</title>
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../../dashboard/index.html" class="navbar-brand">
                ...
                <h4 class="logo-title">Mater One</h4>
            </a>
            ...
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="http://200.63.98.35/prototipo/html/dashboard/index.php" tabindex="-1">
                            <span class="default-icon">Home</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="http://200.63.98.35/prototipo/html/dashboard/index.php">
                            <i class="icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="bodega30rpCollapse"><br>
                                    ...
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-30RP.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor.php">Ingreso del Auditor</li><br>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-17RPrpCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-17RP.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso2.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra2.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor2.php">Ingreso del Auditor</li><br>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-29-RT-REPARACIONESCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-29-RT-REPARACIONES.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso3.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra3.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor3.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-35-AUTOMATCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-35-AUTOMAT.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/formulario-bod35aut.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra4.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor4.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-3RPCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-3RP.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/form_3rp.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra5.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor5.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-8-MANTCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-8-MANT.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/form_8mant.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra6.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor6.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-9-HIDRAULICACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-9-HIDRAULICA.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/form_BODEGA-9-HIDRAULICA.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra7.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor7.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-10-SERV-HIDCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-10-SERV-HID.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso8.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra8.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor8.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-17-DEV-CLTCollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-17-DEV-CLT.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso9.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra9.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor9.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="BODEGA-CALAMACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/BODEGA-CALAMA.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso10.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra10.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor10.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="MATERIA-PRIMACollapse"><br>
                                    <!-- Contenido colapsable aquí -->
                                    <ul>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/MATERIA-PRIMA.php">Ver Inventario</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/formulario-materia.php">Ingresar Producto</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_muestra11.php">Ingreso de muestra</a></li>
                                        <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso_auditor11.php">Ingreso del Auditor</li><br>
                                        <!-- Agrega más opciones aquí si es necesario -->
                                    </ul>
                                </div>
                            </li>
                        ...
                        <ul class="sub-nav collapse" id="resumenBodegas" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="#verTotales" data-toggle="collapse" data-target="#verTotalesCollapse">
                                    ...
                                    <li><a href="http://200.63.98.35/prototipo/html/dashboard/table/resumenes.php"><i class="fa-solid fa-check-double"></i>  Ver totales</a></li>
                                    <li><a href="http://200.63.98.35/prototipo/html/dashboard/form/ingreso-resumen.php"><i class="fa-solid fa-check-double"></i>  Ingresar Producto</a></li><br>
                                </a>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="http://200.63.98.35/prototipo/html/dashboard/extra/usuarios.php">
                                    <i class="icon">
                ...
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title">David Fuentes</h6>
                      ...
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                  ...
                                  <p>En este segmento podras ingresar algun Producto al inventario de la bodega BODEGA-30RP para su resgistro</p>
                              </div>
            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title"> Formulario de Ingresos para BODEGA-30RP </h4>
                     </div>
                  </div>
                  <div class="card-body">
                        <p>Por favor, complete el siguiente formulario para registrar nuevos productos en el inventario de nuestra empresa.</p>
                        <form action="http://200.63.98.35/prototipo/html/dashboard/form/logica/guardar_muestra10.php" method="post">
                        
                            <div class="mb-3">
                                <label for="unidadesSeleccionadasAdm" class="form-label">UNIDADES SELECCIONADAS ADM</label>
                                <input type="text" class="form-control" id="unidadesSeleccionadasAdm" name="unidadesSeleccionadasAdm">
                            </div>
                            <div class="mb-3">
                                <label for="unidadesSeleccionadasAuditoria" class="form-label">UNIDADES SELECCIONADAS AUDITORIA</label>
                                <input type="text" class="form-control" id="unidadesSeleccionadasAuditoria" name="unidadesSeleccionadasAuditoria">
                            </div>
                            <div class="mb-3">
                                <label for="unidadesNoSeleccionadas" class="form-label">UNIDADES NO SELECCIONADAS</label>
                                <input type="text" class="form-control" id="unidadesNoSeleccionadas" name="unidadesNoSeleccionadas">
                            </div>
                        ...
                        <script>
                            $(document).ready(function() {
                                $('#tabla_seleccionada').on('change', function() {
                                    var nombreBodega = $(this).val();
                                    console.log("Bodega seleccionada:", nombreBodega); // Verificar el valor capturado
                                    if(nombreBodega) {
                                        $.ajax({
                                            url: 'obtenerDatosBodega.php', // Asegúrate de que esta URL es correcta
                                            type: 'POST',
                                            data: { bodega: nombreBodega },
                                            dataType: 'json',
                                            success: function(data) {
                                                console.log("Datos recibidos:", data);
                                                // Asumiendo que 'data' es un objeto con las propiedades: valorTotal, totalInventario, valorContable
                                                $('#valor_total').val(data.valor_total); // Asegúrate de que los IDs de los campos sean correctos
                                                $('#total_inventario').val(data.existencia);
                                                $('#valor_contable').val(data.valor_auditoria);
                                            },
                                            error: function() {
                                                alert('Error al obtener datos de la bodega');
                                            }
                                        });
                                    } else {
                                        // Opcional: Limpiar los campos si no se selecciona ninguna bodega
                                        $('#valor_total').val('');
                                        $('#existencia').val('');
                                        $('#valor_auditoria').val('');
                                    }
