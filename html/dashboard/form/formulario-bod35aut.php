            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title"> Formulario de Ingresos para BODEGA-35-AUTOMAT</h4>
                     </div>
                  </div>
                  <div class="card-body">
                      <p>Por favor, complete el siguiente formulario para registrar nuevos productos en el inventario de nuestra empresa.</p>
                      <form action="http://localhost/prototipo/html/dashboard/form/logica/SEGUN_35.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="nombre_tabla" name="nombre_tabla">
                                    ...
                                    <option value="MATERIAL_FERRETERIA">MATERIAL_FERRETERIA</option>
                                    <option value="MATERIAL_TRANSMISION">MATERIAL_TRANSMISION</option>
                                    <option value="MATERIAL_ELECTRICO">MATERIAL_ELECTRICO</option>
                                    <option value="MAQUINAS_Y_HERRAMIENTAS">MAQUINAS_Y_HERRAMIENTAS</option>
