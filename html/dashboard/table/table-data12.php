                        ...
                        <thead>
                            <tr>
                                ...
                                if (isset($_SESSION['rol'])) {
                                        ...
                                        if ($_SESSION['rol'] === 'administrador' || $_SESSION['rol'] === 'ejecutivo' || $_SESSION['rol'] === 'general') {
                                            echo '
                                ...
                                <th>Observaciones<br>Ubicación</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if (isset($_SESSION['rol']) && $_SESSION['rol'] === 'administrador'|| $_SESSION['rol'] === 'ejecutivo'|| $_SESSION['rol'] === 'general') {
                                        echo "<td>" . $row['codigo_producto'] . "</td>";
                                        echo "<td>" . $row['INVENT COBRA'] . "</td>";
                                        echo "<td>" . $row['AUDITORIA HVJ'] . "</td>";
                                        echo "<td>" . $row['Valor INV Auditoria'] . "</td>";
