...
<html lang="en" dir="ltr">
  ...
  <body class="  ">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
      ...
      <div class="conatiner-fluid content-inner mt-n5 py-0">
                    ...
                    <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                        <div class="card-body">
                            <div class="progress-widget">
                                ...
                                <p  class="mb-2">Valor universo total</p>
                    ...
                    <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="800">
                        <div class="card-body">
                            <div class="progress-widget">
                                ...
                                <div class="progress-detail">
                                <p  class="mb-2">Toma inventario</p>
        ...
        <div class="col-md-12 col-lg-8">
            <div class="row">
                <div class="col-md-12 ">
                    <canvas id="miGraficoDeBarras" width="400" height="200"></canvas><br>
                    <br>
                    <script>
                        // Datos del gráfico
                        var datos = {
                            etiquetas: ['BODEGA-30RP', 'BODEGA-17RP', 'BODEGA 29 RT REPARACIONES', 'BODEGA-35-AUTOMAT', 'BODEGA-3RP', 'BODEGA-8 MANT', 'BODEGA-9 HIDRAULICA', 'BODEGA-10-SERV HID', 'BODEGA-17 DEV CLT', 'BODEGA-CALAMA'],
                            datos: [30, 50, 20, 40, 60, 25, 35, 45, 55, 65]
                        };
                ...
                <div class="col-md-12 col-xl-6">
                    ...
                    <p id="totalInventario"></p>

                    <script>
                        // Datos del gráfico
                        var datos = {
                            etiquetas: ['BODEGA-30RP', 'BODEGA-17RP', 'BODEGA 29 RT REPARACIONES', 'BODEGA-35-AUTOMAT', 'BODEGA-3RP', 'BODEGA-8 MANT', 'BODEGA-9 HIDRAULICA', 'BODEGA-10-SERV HID', 'BODEGA-17 DEV CLT', 'BODEGA-CALAMA'],
                            datos: [199500, 85, 93, 1196, 81095, 5380, 2884, 7, 85, 3801]
                        };
                        ...
                        var totalInventario = datos.datos.reduce((total, cantidad) => total + cantidad, 0);

                        // Mostrar el total del inventario en el párrafo
                        document.getElementById('totalInventario').innerText = 'El total del inventario es de ' + totalInventario;

                        // Configurar y dibujar el gráfico
                        var miGrafico = new Chart(ctx, {
                            type: 'doughnut', // Tipo de gráfico circular (dona)
                            data: {
                                labels: datos.etiquetas,
                                datasets: [{
                                    label: 'Mi Gráfico Circular',
                                    data: datos.datos,
                                    backgroundColor: ['rgba(255, 99, 132, 0.8)', 'rgba(54, 162, 235, 0.8)', 'rgba(255, 206, 86, 0.8)', 'rgba(75, 192, 192, 0.8)', 'rgba(153, 102, 255, 0.8)', 'rgba(255, 159, 64, 0.8)', 'rgba(255, 0, 0, 0.8)', 'rgba(0, 255, 0, 0.8)', 'rgba(0, 0, 255, 0.8)', 'rgba(128, 128, 128, 0.8)'],
        ...
        <div class="col-md-12 col-lg-4">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="pb-4 border-0 card-header">
                        <div class="p-4 border border-white rounded primary-gradient-card">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                <h5 class="font-weight-bold">HVJ CHILE</h5>
                                <P class="mb-0">Consultor & Auditor</P>  
                                </div>
                            ...
                            <div class="my-4">
                                <div class="card-number">
                                    <center><img src="../assets/images/1.PNG" style="width: 160px; height: 90px;"></center>
                                </div>
                            </div>
                    ...
                    <div class="grid-cols-2 d-grid gap-card">
                        ...
                        if ($_SESSION['rol'] === 'administrador') {
                            ...
                            echo '
                                <button class="p-2 btn btn-info text-uppercase" data-bs-toggle="modal" data-bs-target="#modalUsuarios2">REVISAR USUARIOS</button>
                                ';
                        ...
                        ?>
                        <button class="p-2 btn btn-primary text-uppercase" data-bs-toggle="modal" data-bs-target="#modalUsuarios">CONTACTO</button>
                    </div>
                </div>
                            ...
                            <div class="modal-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>David Fuentes Arriagada</td>
                                                <td>david.fuentes.arriagada@gmail.com</td>
                                                <td>+56985815739</td>
                                            </tr>
                ...
                <div class="modal fade" id="modalUsuarios2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Listado de Usuarios</h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT  nombres, apellidos, email, numero_telefonico FROM usuarios";
    ...
    <script>
        console.log("Nombre de usuario: <?php echo $nombre_de_usuario; ?>");
        console.log("ruta de imagen: <?php echo $imagen_perfil ; ?>");
